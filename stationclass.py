...
class Compute_parameters_for_station():
    ...
    def __init__(self, user, password, host, database, query_for_unit_1, query_for_unit_2, query_for_unit_3):
    ...
    def sfti(self):
        return self.Unit1_UFTI + self.Unit2_UFTI + self.Unit3_UFTI
